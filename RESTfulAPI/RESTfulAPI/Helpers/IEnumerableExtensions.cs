...
namespace RESTfulAPI.Helpers
{
    public static class IEnumerableExtensions
    {
            ...
            string fields)
        {
            ...
            // expensive, so rather than doing it for each objet in the list, we do
            ...
            else
            {
                ...
                //
                // the field are separated be ",", so we split it.
                ...
                foreach (var field in fieldsAfterSplit)
                {
                    ...
                    // we need to include public and instance, b/c specifying a binding flag oerwrites the
